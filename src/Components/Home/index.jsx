      ...
      return (
        <div className="col-md-4">
          <div className="card mb-4 shadow-sm">
            <img className="card-img-top" alt="Imagem principal do restaurante" style={{ height: '225px', width: '100%', display: 'block' }} src={restaurant.coverImage} />
      ...
      <Layout>
        <section className="jumbotron text-center">
          <div className="container">
            <h1 className="jumbotron-heading">Duo Gourmet Challenge</h1>
            <p className="lead text-muted">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Phasellus quis venenatis dui, vel commodo dui. Aenean et consequat orci, sit amet tincidunt enim. Nulla ac finibus erat. Donec feugiat tempus erat, ac tincidunt dolor.</p>
            <p>
              <a href="#" className="btn btn-primary my-2">BTN_1</a>
              <a href="#" className="btn btn-secondary my-2">BTN_2</a>
            </p>
          </div>
        </section>
